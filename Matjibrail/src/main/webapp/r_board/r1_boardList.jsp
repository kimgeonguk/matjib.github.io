...
<b style="font-size: 25pt; color: #81BEF7;">맛집리뷰 - 2호선 (1) : 신촌 ~ 뚝섬</b>
</div>
<br>
<div align="right">
<form action="r1_boardList.jsp" name="searchHeaderForm" align="right" onsubmit="return checkSearchHeader()">
...
if(count > 0) {
	...
	<input type="button" style="position:absolute; left:5%; width:85px; height:40px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-size:12pt; font-weight: bold; cursor: pointer;" 
						onclick="location.href='r1_boardList.jsp'" value="목록">
