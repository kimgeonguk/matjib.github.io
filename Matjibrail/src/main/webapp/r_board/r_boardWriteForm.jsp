...
<b style="font-size: 25pt; color: #81BEF7;">맛집리뷰 - 글작성</b>
</div>
<br><br><br>
...
<table width="1000" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td width="140"  align="center"><a style="font-size: 14pt; font-weight: bold;">구간 선택</a></td>
		<td width="330" height="10">
			<select name="mr_bcheck" onchange="stationChoice(this)" style="width: 200px; height: 28px; border: 1px solid; border-color:#81BEF7; border-radius: 5px; outline: 1px solid #81BEF7; margin-left: 7%;" value='<%=getParam(request, "mr_bcheck") %>'>
		...
		<td width="140" align="center"><a style="font-size: 14pt; font-weight: bold;">역이름 선택</a></td>
		<td width="330" height="10">
			<select name="mr_header" id="mr_header"  style="width: 200px; height: 28px; border: 1px solid; border-color:#81BEF7; border-radius: 5px; outline: 1px solid #81BEF7; margin-left: 7%; text-align: center;" value='<%=getParam(request, "mr_header") %>'>
	...
	<tr >
		...
		<td colspan="3" align="center"><input type="text" size="50" maxlength="50" style="width: 800px; height: 23px; border: 1px solid; border-color:#81BEF7; border-radius: 5px; outline: 1px solid #81BEF7;" name="mr_subject" value='<%=getParam(request, "mr_subject")%>'></td>
	</tr>
	...
	<tr>
		...
		<input type="hidden" size="20" maxlength="20" style="margin-left: 6%" name="mr_writer" value='<%=loginID %>'>
		<input type="hidden" size="20" maxlength="20" style="margin-left: 6%" name="mr_pass" value='<%=1234%>'> <%--일단 디폴트로 1234 --%>
		</td>
		
		<%-- <td width="140" align="center">비밀번호</td>
		<td width="330"><input type="password" size="20" maxlength="20" style="margin-left: 6%" name="mr_pass" value='<%=getParam(request, "mr_pass")%>'></td> --%>
	</tr>
	...
	<tr height = "500px">
		<td colspan="4"><textarea style="margin-left: 2%; resize: none; width: 1000px; height:480px; border-radius: 5px; border-color:#81BEF7; outline: 1px solid #81BEF7; "  name="mr_content"><%=getParam(request, "mr_content")%></textarea></td>
	</tr>
	...
	%>
	<form action="r_boardWriteProc.jsp" encType="multipart/form-data" method="post" onsubmit="return checkWriteForm()">
		...
		<input type="file" name="mr_image<%=i + 1%>"><br>
		</div>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input type="button" value="목록으로"  style="width: 130px; height:40px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-weight: bold; cursor: pointer;" onClick="window.location='r_boardList.jsp'">
			</td>
		</tr>
		</table>
</form>
