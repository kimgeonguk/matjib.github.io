...
<table id="list" width="1270" border="0" cellpadding="0" cellspacing="0" align="center">
 ...
 <tr height="30">
  ...
  %>
   ...
   <a href="f_boardContent.jsp?mf_num=<%= article.getMf_num()%>&pageNum=<%=currentPage%>" style="margin-left: 8%">
    <%=article.getMf_subject() %></a> 
    <%if(article.getMf_readcount() >= 20) { %>
    <img alt="" src="img/hot.gif" border="0" height="16">
    <%} %>
    <td align="center" width="100" style=" border-bottom: 1px dashed #E6E6E6;"><a><%=article.getMf_writer() %></a></td>
  <td align="center" width="130" style=" border-bottom: 1px dashed #E6E6E6; "><a><%=sdf.format(article.getMf_postdate()) %></a></td>
  <td align="center" width="50" style=" border-bottom: 1px dashed #E6E6E6; "><a><%=article.getMf_readcount() %></a></td>
 </tr>
 <%} %>
</table>
...
if(count > 0) {
	...
	<input type="button" style="position:absolute; left:5%; width:85px; height:40px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-size:12pt; font-weight: bold; cursor: pointer;" 
						onclick="location.href='f_boardList.jsp'" value="목록">
	<input type="button" style="position:absolute; right:5%; width:85px; height:40px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-size:12pt; font-weight: bold; cursor: pointer;" 
						onclick="location.href='f_boardWriteForm.jsp'" value="글쓰기">
<br><br><br>
