...
<div id="nav">
	...
	%>
	<div id="section" onload="begin()">
	<div align="center">
	<br><br><br><br><br>
		<b style="font-size: 35pt; font-weight: bold; ">회원탈퇴</b>
	<br><br><br>
	<a style="font-size: 15pt; font-weight: bold; color: #81BEF7">본인 확인을 위해 <b style="color: red;">비밀번호</b>를 입력해주세요.</a><br>
	<a style="font-size: 13pt; font-weight: bold; color: #81BEF7"><b style="color: red;">회원탈퇴</b> 버튼을 누르시면 처리가 완료됩니다.</a>
		<br><br><br>
		<form action="deleteProc.jsp" name="myForm" method="post" 
			onsubmit="return checkIt()">
			<table border="0">
				<tr>
					<td align="left" style="width:100px; height: 60px; text-align: center;"><b style="font-size: 13pt;">비밀번호</b></td>
					<td>
						<input type="password" name="pass" size="15" style="width: 220px; height: 28px; border: 1.5px solid; border-color:  #81BEF7; border-radius: 4px;">
					</td>
				</tr>

				<tr>
					<td colspan="2" align="center" style="height: 100px;">
					<input type="submit" value="회원탈퇴" style="width:130px; height:38px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-weight: bold; font-size: 11pt; color:black; cursor: pointer;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					
					<input type="button" value="취소" style="width:130px; height:38px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-weight: bold; font-size: 11pt; color:black; cursor: pointer;"
