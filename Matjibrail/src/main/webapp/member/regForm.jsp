...
<br><br><br>
<div align="center">
	<b style="font-size: 35pt; font-weight: bold; ">회원가입</b><br><br>
	<a style="color: black; font-size: 20px; font-weight: bold; color: #81BEF7">회원가입을 위해 모든 정보를 기입해주세요.</a>
	
	<br><br><br>
<form action="regProc.jsp" method="post" name="regForm" id="regForm">
<table>
	<tr>
		<td align="right" style="font-size: 13pt; font-weight: bold">아이디&nbsp;&nbsp; </td>
		<td>
			<input type="text" name="id" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7;">&nbsp;
			<input type="button" value="중복확인" onClick="idCheck(this.form.id.value)" style="width: 80px; height:30px; border: 1px soild; border-radius: 4px; border-color:#81BEF7; font-weight: bold; background-color:#CEE3F6; cursor: pointer;">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="password" name="pass" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	<tr>
		<td align="right"  style="font-size: 13pt; font-weight: bold">비밀번호 확인&nbsp;&nbsp; </td>
		<td>
			<input type="password" name="repass" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="name" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	<tr>
		<td align="right" style="font-size: 13pt; font-weight: bold">영문명&nbsp;&nbsp; </td>
		<td>
			<input type="text" name="english" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="email" name="email" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<select name="phone1" style="width: 50px; height: 28px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
			...
			<input type="text" name="phone2" size="5" style="width: 70px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">-
			<input type="text" name="phone3" size="5" style="width: 70px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	...
	<tr>
		...
		<td> 
			<input type="text" name="zipcode" style="width: 70px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">&nbsp;
	...
	<tr>
		...
		<td>
			<input type="email" name="address1" size="50" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>
	<tr>
		<td align="right" style="font-size: 13pt; font-weight: bold">나머지주소&nbsp;&nbsp; </td>
		<td>
			<input type="email" name="address2" size="30" style="width: 200px; height: 22px; border: 1px soild; border-radius: 4px; border-color:#81BEF7 ">
		</td>
	</tr>

	<tr>
		<td align="right" style="font-size: 13pt; border-radius: 4px; font-weight: bold">선호 음식 (선택)&nbsp;&nbsp;</td>
		<td>
	...
	<tr>
		<td colspan="2" align="center">
			<input type="button" value="회원가입" onClick="inputCheck()" style="width: 130px; height:35px; border: 1px soild; border-radius: 4px; border-color:#81BEF7; font-weight: bold; background-color:#CEE3F6; cursor: pointer; ">&nbsp;&nbsp;
