...
<div id="section">
	...
	<br><br><br><br><br>
	<div align="center">
	<b style="font-size: 35pt; font-weight: bold; ">비밀번호 찾기</b>
	<br><br><br>
		<a style="font-size: 15pt; font-weight: bold; color: #81BEF7">등록 정보 확인을 위해 아이디와 영문명, E-mail을 입력해주세요.</a>
		<br><br><br>
		<form action="findPwResult.jsp" method="post">
				<table>
					<tr>
						<td align="left"  style="width: 100px; height: 50px; text-align: center;"><b style="font-size: 13pt;">아이디</b></td>
						<td><input type="text" name="id" style="width: 220px; height: 28px; border: 1.5px solid; border-color:  #81BEF7; border-radius: 4px;"></td>
					</tr>
					<tr>
						<td align="left"  style="width: 100px; height: 50px; text-align: center;"><b style="font-size: 13pt;">영문명</b></td>
						<td><input type="text" name="english" style="width: 220px; height: 28px; border: 1.5px solid; border-color:  #81BEF7; border-radius: 4px;"></td>
					</tr>
					<tr>
						<td align="left"  style="width: 100px; height: 50px; text-align: center;"><b style="font-size: 13pt;">E-Mail</b></td>
						<td><input type="text" name="email" style="width: 220px; height: 28px; border: 1.5px solid; border-color:  #81BEF7; border-radius: 4px;"></td>
					</tr>
					<tr>
