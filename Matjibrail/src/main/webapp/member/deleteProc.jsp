	...
	%>
		<div id="section">
			...
			<div style="text-align: center;">
				...
				<br><br><br><br>
				<a style="font-size: 30px;  font-weight:bold; color: #81BEF7;">회원탈퇴처리가 완료되었습니다.</a><br><br>
				<a style="font-size: 30px;  font-weight:bold; color: #81BEF7;">그 동안 이용해주셔서 감사합니다.</a><br>
				<br>
				<br>
				<br>
				<br>
				...
				<input type="button" style="width:200px; height:40px; background-color:#CEE3F6; border:1px solid; border-color:#81BEF7; border-radius: 5px; font-weight: bold; cursor: pointer;" 
									onclick="location.replace('mypage.jsp')" value="로그인 화면으로">
